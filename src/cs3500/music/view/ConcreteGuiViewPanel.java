...
public class ConcreteGuiViewPanel extends JPanel {
    ...
    /**
     * Sets the list of notes to be the list of notes in the model
     * Sets the min to be the min of the list (its keyVal)
     * Sets the max to the max of the list (its keyVal)
     * The duration is the duration of the model
     * the previous tick is initialized to -1
     * the tick is set to zero
     *
