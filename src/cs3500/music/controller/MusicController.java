...
public class MusicController implements ActionListener {
     ...
     * @param m model
     * @param v view
     *          Sets the keyboardHandler to a new keyBoardHandler
     *          Sets the mouseListener to a new MouseListener
     *          the controller's isPlaying starts out as false
     *          the controller's removalState starts out as false
     *          If the given view supports keyboard and mouse events:
     *          This constructor also configures the keyboard and mouse commands for the project:
     *          By clicking anywhere, users are able to add a note
     *          By pressing r, users enter "removal mode" and are able to click on a note to remove it
     */
    ...
    private int getPitchFromLocation(int y) {
        ...
        return -(((y - ConcreteGuiViewPanel.DISTANCE_FROM_TOP) / ConcreteGuiViewPanel.PIXEL_SIZE) - max);
    }
