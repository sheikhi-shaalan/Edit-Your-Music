...
/**
 * Created by baharsheikhi on 6/20/16. To represent the mouseListener of this project
 */
public class MouseListenerImpl implements MouseListener {
  ...
  /**
   * Creates a new MouseListenerImpl with empty Maps. The x and y fields are not set to a default
   * value
   */
