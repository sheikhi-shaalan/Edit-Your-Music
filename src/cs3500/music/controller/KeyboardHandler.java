 ...
 * To represent a keyboard handler for this project
 */
public class KeyboardHandler implements KeyListener {
    ...
    /**
     * An empty constructor that creates empty hashmaps for the different types of key handles:
    ...
    /**
     * Executes the runnable of the given Keyevent for the
     * typed commands
     *
