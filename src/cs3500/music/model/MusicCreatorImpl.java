...
/**
 * The implementation for the MusicCreator model of this project
...
public class MusicCreatorImpl implements MusicCreator {
    ...
    /**
     * Creates a default MusicCreatorImpl object:
     * the composition is set to an empty hashmap
     * The tempo is default set to 120 BPM
     */
    ...
    /**
     * Creates a MusicCreatorImpl object:
     * The notes in the given List<Note></Note> are added
     * to the composition
     *
    ...
    public static final class Builder implements CompositionBuilder<MusicCreator> {
        ...
        /**
         * A constructor that default sets the tempo to 2,000,000 microseconds
         * per quarter note and the composition to an empty arraylist of notes
         */
        private Builder() {
            this.tempo = 200000;
