...
public class Note implements Comparable<Note> {
  /**
   * An enum to represent pitches of notes: starting with C and up until B. Only includes Sharp, not
   * flat.
   */
  public enum Pitch {
  ...
  /**
   * Custom constructor with the volume set to 64 and the instrument to 1 (piano).
   *
   ...
   * @param octave   the octave of the new note Throws an IllegalArgumentException if the beat or
   *                 duration is less than 0. Throws an IllegalArgumentException if the octave is
   ...
   * @param volume     the volume of the new note Throws an IllegalArgumentException if: The beat,
   *                   pitch, duration, instrument, or volume are less than 0 The instrument is
   *                   greater than 128 The volume is greater than 127
   */
