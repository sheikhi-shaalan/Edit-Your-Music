...
public class KeyboardHandlerTest {
    ...
    KeyEvent homeKey = new KeyEvent(new Component() {
    }, 0, 10,
            InputEvent.BUTTON1_MASK, KeyEvent.VK_HOME, ' ', 0);

    KeyEvent endKey = new KeyEvent(new Component() {
    }, 0, 10,
            InputEvent.BUTTON1_MASK, KeyEvent.VK_END, ' ', 0);

    KeyEvent spaceBar = new KeyEvent(new Component() {
    }, 0, 10,
            InputEvent.BUTTON1_MASK, KeyEvent.VK_SPACE, ' ', 0);

    KeyEvent r = new KeyEvent(new Component() {
    }, 0, 10,
